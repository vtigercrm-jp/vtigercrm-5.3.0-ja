...
var alert_arr = {				
	...
	SELECT_MAILID:'Please select an email address',
	...
	CANT_SELECT_CONTACTS:'You can not select related contacts from Lead',
	LBL_THIS:'This ',
	...
	CODE:' Code: ',
	WISH_TO_QUALIFY_MAIL_AS_CONTACT:'Are you sure you wish to Qualify this Email as a Contact?',
	...
	CURRENCY_CONVERSION_INFO:'Are you using the Dollar $ as Currency?/nClick OK to remain as $, Cancel to change the currency conversion rate.',
	...
	LBL_PROVIDE_YES_NO:' Invalid value./nPlease respond Yes or No',
	LBL_SELECT_CRITERIA:' Invalid criteria./nPlease select criteria',
	...
	ENDS_WITH:'ends with',
	SHARED_EVENT_DEL_MSG:'The User does not have permission to Edit or Delete Shared Event.',
	LBL_WRONG_IMAGE_TYPE:'Allowed file types for Contacts - jpeg, png, jpg, pjpeg, x-png or gif',
	SELECT_MAIL_MOVE:'Please select an email and then move..',
	...
	LBL_SEARCH_WITHOUTSEARCH_ALL:'You have used search option but you have not selected without search & all options./nYou can click [ok] to export all data or You can click [cancel] and try again with other export criteria',
	STOCK_IS_NOT_ENOUGH:'Stock is not enough',
	INVALID_QTY:'Invalid Qty.',
	LBL_SEARCH_WITHOUTSEARCH_CURRENTPAGE:'You have used search option but you have not selected without search & currentpage options./nYou can click [ok] to export current page data or You can click [cancel] and try again with some other export criteria.',
	LBL_SELECT_COLUMN:' Invalid column./nPlease select column',
	...
	POTEN_MANDATOR:'Select the mandatory field Potential Name',
	...
	FOLDER_NAME_TOO_LONG:'Folder name is too long. Please try again',
	...
	FOLDER_DESCRIPTION_TOO_LONG:'Folder description is too long. Please try again',
	NOT_PERMITTED:'You are not permitted to execute this operation',		
	ALL_FILTER_CREATION_DENIED:'Cannot create Custom View using name "All", try using different View Name',
	OPERATION_DENIED:'You are not allowed to perform this operation',
	...
	LBL_CANNOT_HAVE_EMPTY_VALUE:'Cannot replace with blank value. Please use the Delete option to remove the value',
	...
	LABEL_CANNOT_NOT_EMPTY:'Label cannot be empty',
	...
	LBL_FOLDER_SHOULD_BE_EMPTY:'Folder must be empty to remove it',
	...
	/* Tooltip management */
	ERR_FIELD_SELECTION:'Error in field selection',
	...
	'LBL_ADD_HOME_WIDGET': 'Unable to add home stuff! Please try again',
