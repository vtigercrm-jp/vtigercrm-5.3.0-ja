...
'Dear_Admin_too_ many_tickets_pending'=>'Dear Admin,<br /><br />This is to bring to your notice that there are too many tickets pending. Kindly take the necessary action required for addressing the same<br><br> Thanks and Regards,<br> HelpDesk Team<br />',
...
'DELETING_ACCOUNT'=>'Deleting this account(s) will remove its related Potentials, Quotes, Sales Orders &amp; Invoices. Are you sure you want to delete the selected ',
...
'FOLDER'=>' folder ?',
'ACCOUNT_ACCESS_INFO'=>'Potentials, Help Desk, Quotes, Sales Order &amp Invoice Access must be set to Private when the Account Access is set to Private',
...
//For Configuring/Using Purchase Order number
'PO Number'=>'PO Number',
...
'LBL_MERGE_SELECT'=>'Select records (max: 3)',
