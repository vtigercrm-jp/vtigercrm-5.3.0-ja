...
'QuoteNotificationDescription'=>'During quote generation if the product stock in warehouse is less than the quantity mentioned in quote then this notification will be sent to the product handler',

'SalesOrderNotification'=>'Product Stock Notification during Sales Order Generation',
'SalesOrderNotificationDescription'=>'During sales order generation if the product stock in warehouse is less than the quantity mentioned in sales order then this notification will be sent to the product handler',
