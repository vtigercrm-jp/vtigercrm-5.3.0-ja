...
'leadCustomFieldDescription'=>'Map each of your organisations Lead Custom Fields to each of your Custom Account
...
'LBL_CUSTOM_MAPP_INFO'=>'Only in the Leads module can you map the fields with Accounts, Contacts, and Potentials.',
...
'LBL_CHECK_ASSIGNEDTO_MAILID'=>'Please check the assigned-to email ID',
'LBL_MAILSENDERROR'=>'Mail could not be sent to the admin user. Please check the admin email ID and/or server settings',
...
'LEADS_CUSTOM_FIELD_MAPPING_DESCRIPTION' => 'Map Your Leads\' Custom Fields with Accounts, Contacts and Potentials',
...
'LBL_OPTIONS2'=>"Add od1.vtiger.com server as a authorised sender for your domain.<br>
