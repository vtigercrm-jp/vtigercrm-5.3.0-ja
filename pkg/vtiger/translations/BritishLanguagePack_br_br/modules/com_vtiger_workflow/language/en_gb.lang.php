...
$mod_strings = array(
	...
	'LBL_CREATE_ENTITY_NOTE_ORDER_MATTERS' => 'Note: Expressions will be evaluated in the order of the field values provided,
												so be sure to provide a value for a field before using it in expressions.',
	...
	'LBL_WORKFLOW_NOTE_EVENT_TASK_TIMEZONE' => 'Note: All date, time and recurring information configured for the event
													will be with respect to the default time zone, configured in config.inc.php',
