...
'MESSAGE_MAIL_ID_IS_INCORRECT'=>'Email ID is incorrect. Please Check this Email ID...',
...
'LBL_CC_EMAIL_ERROR'=>'Your cc email ID is not correct',
'LBL_BCC_EMAIL_ERROR'=>'Your bcc email ID is not correct',
...
'LBL_VTIGER_EMAIL_CLIENT'=>'vtiger Webmail Client',
'LBL_MAILSELECT_INFO3'=>'You do not have permission to view email id(s) of the selected Record(s).',
...
'LBL_BYTES' => ' bytes',
'LBL_CHECK_USER_MAILID' => 'Please check the current user email ID. It should be a valid email ID to send emails',
