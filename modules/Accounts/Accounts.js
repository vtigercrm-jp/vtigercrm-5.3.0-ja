...
//JFV
		...
		if (addressType == 'Main'){
			otherLoc.setAreaTypeByCountry('bill_country')
		}else{
			otherLoc.setAreaTypeByCountry('ship_country')
		}
		if(null != otherLoc.areaType){ 	// address area isn't normal type, eg. japan or china
			if (addressType == 'Main'){
				var addressOrderAry = [/*bill_code,*/'bill_country','bill_state','bill_city'/*,'bill_pobox'*/,'bill_street']
			}else{
			var addressOrderAry = [/*ship_code,*/'ship_country','ship_state','ship_city'/*,'ship_pobox'*/,'ship_street']
			}
